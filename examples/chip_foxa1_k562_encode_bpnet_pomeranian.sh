#!/usr/bin/env bash
# ENCODE FOXA1 K562 preprocessing + training example for Cerberus.
#
# This script:
...
#
# Usage:
#   bash examples/chip_foxa1_k562_encode_bpnet_pomeranian.sh
#   bash examples/chip_foxa1_k562_encode_bpnet_pomeranian.sh --multi

set -euo pipefail

DATA_DIR="data/ENCODE_FOXA1_K562"
PREPROCESS_SCRIPT="tools/preprocess_bam_bed_for_cerberus.sh"
PREFIX="encode_foxa1_k562_rep1"

# ENCODE files from experiment ENCSR819LHG (replicate 1 only)
BAM_REP1="${DATA_DIR}/ENCFF543GEC_replicate1.bam"
BED_REP1="${DATA_DIR}/ENCFF624PSE_replicate1.bed.gz"
...
BP_OUTPUT_ROOT="data/models/chip_foxa1_k562_encode_rep1_bpnet_residual_architectures"
POM_OUTPUT_DIR="data/models/chip_foxa1_k562_encode_rep1_pomeranian"
