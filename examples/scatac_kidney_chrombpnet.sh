...
# pseudobulk BigWig produced by the Cerberus pseudobulk pipeline, then
# writes training curves and held-out prediction-evaluation outputs by
# default.  The pseudobulk outputs must already exist in DATA_DIR (see
# examples/scatac_kidney_pseudobulk.sh to generate them).
#
# Prerequisite:
