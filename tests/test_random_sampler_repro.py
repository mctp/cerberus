...
class TestRandomSamplerInconsistencies(unittest.TestCase):
    def test_random_sampler_resample_none_behavior(self):
        ...
        self.assertNotEqual(starts1, starts2, "Intervals identical after resample(None), expected new intervals")
    ...
    def test_multisampler_resample_propagation(self):
        ...
        self.assertNotEqual(starts1, starts2, "MultiSampler intervals identical after resample(None)")
    ...
    def test_scaled_sampler_resample_none_behavior(self):
        ...
        self.assertNotEqual(indices_1, indices_2, "ScaledSampler indices identical after resample(None)")
