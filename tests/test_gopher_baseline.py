...
def test_cnn_large_input():
    ...
    expected_output_bins = output_len // output_bin_size
    assert output[0].shape == (batch_size, 1, expected_output_bins)
...
def test_reshape_layer():
    ...
    from cerberus.models.baseline_gopher import _Reshape
