...
def get_args():
    ...
    # SignalNet overrides
    parser.add_argument("--signal-filters", type=int, default=256, help="SignalNet model dimension")
    parser.add_argument("--signal-dropout", type=float, default=0.1, help="SignalNet dropout rate")

    # Training parameters (defaults follow architecture plan: zero-init makes warmup unnecessary)
    ...
    parser.add_argument("--warmup-epochs", type=int, default=0, help="Number of warmup epochs (0: not needed with zero-init)")
...
def main():
    ...
    model_args = {
        ...
        "signal_filters": args.signal_filters,
