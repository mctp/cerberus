...
def print_model_dims(model_name, input_len=None, output_len=None, verbose=False):
    ...
    if final_input_len is None:
        ...
        if param and param.default != inspect.Parameter.empty:
            ...
            print(f"Warning: input_len not provided and no default found. Using fallback: {final_input_len}")
    ...
    if final_output_len is None:
        ...
        if param and param.default != inspect.Parameter.empty:
            ...
            print(f"Warning: output_len not provided and no default found. Using fallback: {final_output_len}")
    ...
    try:
        ...
        try:
             ...
             if hasattr(model, 'input_len'): final_input_len = model.input_len
             if hasattr(model, 'output_len'): final_output_len = model.output_len
