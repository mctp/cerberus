...
from cerberus.attribution import ATTRIBUTION_MODES
...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--target-mode",
        choices=sorted(ATTRIBUTION_MODES),
        default="log_counts",
...
def _load_target_model(
    ...
    *,
    ...
    fold_dir = resolve_fold_dir(checkpoint_dir.resolve(), fold)
    try:
        hparams_path = find_latest_hparams(fold_dir)
    except FileNotFoundError:
        hparams_path = find_latest_hparams(checkpoint_dir.resolve())
    ...
    return target_model, cfg, fold_dir, hparams_path
...
def main() -> None:
    ...
    target_model, cfg, fold_dir, hparams_path = _load_target_model(
        args.checkpoint_dir,
        args.fold,
        device,
        target_mode=args.target_mode,
